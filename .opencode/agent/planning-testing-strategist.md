---
description: Test strategy planning specialist for new features. Designs comprehensive
  testing approaches including unit, integration, e2e tests, and test data management.
mode: primary
permission:
  bash:
    '*': allow
